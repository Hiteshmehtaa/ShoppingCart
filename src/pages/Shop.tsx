...
export function Shop() {
  ...
  // ✅ Total quantity instead of unique items
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-all duration-300">
      ...
      {/* ✅ NAVBAR (Shop controls its own navbar) */}
      <Navbar cartCount={totalCount} onCartClick={() => setShowCart(true)} />
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        {/* ✅ CATEGORY TABS */}
        <div className="flex gap-6 mb-10 border-b border-gray-200 dark:border-gray-700 pb-2 overflow-x-auto">
          {categories.map((cat) => (
            <button
              key={cat}
        ...
        {showCart && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 h-full w-80 bg-white dark:bg-gray-800 
              border-l border-gray-200 dark:border-gray-700 p-6 z-50 
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-100 transition p-1"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              {cartItems.length === 0 ? (
                ...
                <>
                  ...
                  <div className="border-t border-gray-300 dark:border-gray-600 pt-4">
                    <p className="flex justify-between text-sm font-medium text-gray-800 dark:text-gray-200 mb-3">
                      <span>Total</span>
